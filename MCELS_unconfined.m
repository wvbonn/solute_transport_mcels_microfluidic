function out = MCELS_unconfined(argin)
%
...
model.label('MCELS_unconfined_m.mph');
...
model.param.set('b', '0[mm]', 'height of MCELS center above bottom');
...
model.component('comp1').physics('tds').feature('conc1').selection.set([1 7]);
...
model.component('comp1').physics('tds').feature('sym1').selection.set([2 4 5 6]);
...
model.component('comp1').mesh('mesh1').feature('size1').set('hmax', 0.025/2);
